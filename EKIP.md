...
Anasayfa ekibi (Sorumlu + Yardımcı) ve 3 öncelikli masa (Telefon, Yapay Zekâ, İncelemeler) yardımcı editörle güçlendirildi. Tüm 7 masa en az bir gerçek, kaynağı doğrulanmış haberle dolu; Telefon ve Yapay Zekâ ikişer, Bilgisayar ve Tablet ikişer/üçer haberle en canlı masalar (Bilgisayar 3, Tablet 2, Telefon 2, Yapay Zekâ 2, diğerleri 1'er) — toplam 12 haber `gunluk.html`'deki günlük akışta masa etiketiyle ve doğru kronolojik sırada listeleniyor. Anasayfadaki "Öne Çıkanlar" güncellendi: Google'ın Googlebook platform lansmanı (Bilgisayar), Samsung One UI 9 (Yapay Zekâ) ve Oukitel (Telefon) — Baş Sayfa Sorumlusu, Acer'ın genel donanım haberini daha büyük Googlebook haberiyle değiştirdi. İncelemeler ve Fırsatlar masalarındaki haberler, olayın gerçekleştiği tarihle (sırasıyla 2026-03-13 ve 2026-08-06) etiketlendi — FORTIAY'a eklendikleri gün değil, gelişmenin gerçek tarihi esas alınıyor. Bundan sonraki iş, her masada güncel gelişmeleri takip ederek haber akışını canlı tutmak.
