...
Anasayfa ekibi (Sorumlu + Yardımcı) ve 3 öncelikli masa (Telefon, Yapay Zekâ, İncelemeler) yardımcı editörle güçlendirildi. Tüm 7 masa en az bir gerçek, kaynağı doğrulanmış haberle dolu; Telefon ve Bilgisayar 3'er, Yapay Zekâ/Tablet/Giyilebilir/Fırsatlar/İncelemeler 2'şer haberle en canlı masalar — toplam 16 haber `gunluk.html`'deki günlük akışta masa etiketiyle ve doğru kronolojik sırada listeleniyor. İncelemeler masasının 2. haberi Poco F9 Ultra incelemesi (GSMArena + Philstar Tech, 2026-09-01, iki bağımsız kaynakla çapraz doğrulandı). Telefon masasının 3. haberi TECNO'nun "0mm çerçeve" konsept telefonu (GSMArena + Engadget ile çapraz doğrulandı, 2026-09-01) — bunun henüz satışı sunulmamış bir konsept/teknoloji sergisi olduğu metinde açıkça belirtildi. Anasayfadaki "Öne Çıkanlar" güncellendi: Google'nın Googlebook platform lansmanı (Bilgisayar), Samsung One UI 9 (Yapay Zekâ) ve Oukitel (Telefon) — Baş Sayfa Sorumlusu, Acer'ın genel donanım haberini daha büyük Googlebook haberiyle değiştirdi. İncelemeler, Fırsatlar ve Telefon masalarındaki bazı haberler, olayın gerçekleştiği tarihle (2026-03-13, 2026-08-06, 2026-09-01) etiketlendi — FORTIAY'a eklendikleri gün değil, gelişmenin gerçek tarihi esas alınıyor. Site teması, Input Magazine'in görsel diline (kalın Archivo Black başlıklar, magenta/camgöbeği vurgu renkleri, net gazete tipi ayraçlar) uyacak şekilde tamamen yenilendi. Bundan sonraki ış, her masada güncel gelişmeleri takip ederek haber akışını canlı tutmak.
